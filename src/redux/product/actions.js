...
export const getListCategoriesRequest = createAction('GET_LIST_CATEGORIES_REQUEST');
export const getListCategoriesSuccess = createAction('GET_LIST_CATEGORIES_SUCCESS');
export const getListCategoriesFailure = createAction('GET_LIST_CATEGORIES_FAILURE');
